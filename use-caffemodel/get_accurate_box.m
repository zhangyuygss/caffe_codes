function [accBoxes,accFtr,v_GT] = get_accurate_box(PosBoxes,image_ids,v_GT,iter,image_classes)
cd('get_accurate_box\')
%
...
if doReWrite
    ...
    for i = 1:size(PosBoxes,1)
        ...
        for j = 1:size(PosBoxes{i,1},1)
            ...
            imwrite(tmpImg,strcat('tmpImgs\',imgName(1:6),'_',num2str(j),'.jpg'))
        end
    end
    disp('Get Saliency Map')
    system('H:\zhaolong\IJCAI2016\RC\RC\program\Bin\AttCut.exe tmpImgs\*.jpg tmpSm25 25')
end
