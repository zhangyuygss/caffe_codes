...
model_dir = '/home/zhangyu/data/vggnet/snap/vgg/';
...
model_list = dir('/home/zhangyu/data/vggnet/snap/vgg/*.caffemodel');
for i = 1:length(model_list)
    ...
    for j = 1:length(datasets)
        ...
        tmpdir = ['/home/zhangyu/data/vggnet/unsupervised1/' datasets{j}];        %mkdir 2 arguments max
        mkdir(tmpdir,model_list(i).name(1:end-11));
        smdir = strcat('/home/zhangyu/data/vggnet/unsupervised1/',datasets{j},'/',model_list(i).name(1:end-11));
