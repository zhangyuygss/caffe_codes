function plotFigure(datasetName,allModel,results)
    ...
    colors={[1 0 0],[0.749019622802734 0.749019622802734 0],[0 0.498039215803146 0],...
            ...
            [1 1 0],[0 0 0],[1 0.600000023841858 0.7843137383461],[1 0 1],...
            [0.231372549019608 0.443137254901961 0.337254901960784],[0 0.498039215803146 0]...
            [0 0 0.67],[0 0 0.5],[0.5 0 0],[0 0.5 0]};
    ...
    for i=1:length(allModel)
        plot(recall(:,i)',pre(:,i),'LineWidth',2,'Parent',axes1,'LineStyle',...
            LineStyle{i},'Color',colors{i},'DisplayName',allModel{i});
    ...
    annotation(figure1,'textbox',...
        ...
        'FitBoxToText','off',...
        'LineStyle','none');
    saveas(figure1,['/home/zhangyu/data/vggnet/performance/' datasetName '/' datasetName '.fig']);
    close all
end    
